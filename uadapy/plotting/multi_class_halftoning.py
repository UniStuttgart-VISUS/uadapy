...
def plot_stipples_multiclass(distributions,
                             n_samples,
                             resolution=128, 
                             seed=55, 
                             distrib_colors=None,
    ...
    for idx, cls in enumerate(classes):
        ...
        ax.scatter(x_coords, y_coords, color=cls.color, s=5, label=f"Class {idx}", edgecolors='none')
...
fig, axs = plot_stipples_multiclass(distribs_lo, n_samples=3000, resolution=256, seed=55, show_plot=True)
